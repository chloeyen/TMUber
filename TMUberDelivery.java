...
public class TMUberDelivery extends TMUberService
{
  ...
  public boolean equals(Object other)
  {
    ...
    if(other instanceof TMUberService) {
      TMUberService otherType = (TMUberService) other;
      if(super.equals(otherType)) {
        if(otherType instanceof TMUberDelivery) {
          TMUberDelivery newOther = (TMUberDelivery) otherType;
          if(this.restaurant.equals(newOther.restaurant) && this.foodOrderId.equals(newOther.foodOrderId)){
            return true;
          }
        }
      }
